...
public class FilmDaoImpl implements FilmDao {
	...
	public void charger(Film film) {
		...
		try {
            ...
            preparedStatement = connexion.prepareStatement("SELECT * FROM phrases INNER JOIN films ON phrases.id_film = films.id_film WHERE films.nom=? AND (phrases.id_langue=? OR phrases.id_langue=?) ORDER BY numero ASC");
            preparedStatement.setString(1, film.getNom());
