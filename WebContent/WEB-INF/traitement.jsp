...
<form method="post" action="">
	...
	<c:forEach items="${ film.phrases }" var="phrase" varStatus="status">
		<fieldset>
			...
			<textarea name="precisions" id="precisions" cols="40" rows="2" disabled><c:out value="${phrase.texteOriginal}" /> </textarea>
			<textarea name="precisions" id="precisions" cols="40" rows="2"><c:out value="${phrase.texteTraduit}" /> </textarea>
